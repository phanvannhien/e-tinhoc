                ...
                <div class="row">
                    <div class="col-md-4">
                        <form action="" class="form-inline">
                            ...
                            <button type="submit" class="btn btn-primary btn-sm" value="submit" name="select_menu">@lang('app.select')</button>
                            @if( Request::get('menu') )
                        ...
                        @if( $selected_menu )
                            Menu ID: <span class="text-danger"> {{ $selected_menu->id }}</span>
                            @endif
                    </div>
                    <div class="col-md-8">
                        <form class="form-inline" action="{{ route('menu.store') }}" method="post">
                            ...
                            <button type="submit" name="submit_create_menu"  value="" class="btn btn-success btn-sm"><i class="fa fa-save"></i> @lang('app.save')</button>
                        </form>
                    </div>
                </div>
